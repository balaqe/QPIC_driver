...
#%% Testing structure
test_chip = Chip(qontrol="nope", folder=r"/Users/balage/Documents/@UNI/@KU/@PHASE3/@PROJ/characterization/data/session0")
print(f"Type of chip: {type(test_chip)}")
print(hasattr(test_chip, 'mzi_list'))
test_ps1 = PhaseShifter(test_chip, name='')
test_ps1.in_port  = 4
test_ps1.out_port = 3
test_ps1.channel  = 6
...
test_ps2 = PhaseShifter(test_chip, name='')
test_ps2.in_port  = 4
test_ps2.out_port = 3
test_ps2.channel  = 6
...
test_mzi = MZI(chip=test_chip, name="mzi03", shifter1=test_ps1, shifter2=test_ps2, folder=r"/Users/balage/Documents/@UNI/@KU/@PHASE3/@PROJ/characterization/data/session0")
